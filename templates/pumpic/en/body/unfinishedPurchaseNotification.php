...
<a class="btn" href="<?= $this->analyticsLink('https://pumpic.com/store.html', ['source' => 'system', 'medium' => 'system-email', 'campaign' => 'abandoned_cart', 'term' => 'store']) ?>" style="<?= $style['button'] ?>">
    Go to the Store
</a>
<p style="<?= $style['paragraph'] ?>">
...
<a class="btn" href="<?= $this->analyticsLink('https://pumpic.com/faq.html', ['source' => 'system', 'medium' => 'system-email', 'campaign' => 'abandoned_cart', 'term' => 'faq']) ?>" style="<?= $style['button'] ?>">
    I need help
</a>
<p style="<?= $style['paragraph'] ?>">
