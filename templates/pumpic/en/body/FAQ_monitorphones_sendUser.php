...
<p style="<?= $style['paragraph'] ?>">
    ...
    <?php endif; ?>
    <?php if(isset($params['questtype'])): ?>
    <b class="green" style="<?= $style['colorText'] ?>">Question type:</b> <?= $params['questtype'] ?><br>
    <?php endif; ?>
    <?php if(isset($params['question'])): ?>   
    <b class="green" style="<?= $style['colorText'] ?>">Description:</b> <?= $params['question'] ?>
    <?php endif; ?>
</p> 
<p style="<?= $style['paragraph'] ?>">
