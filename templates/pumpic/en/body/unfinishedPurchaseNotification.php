...
<a class="btn" href="<?= $this->analyticsLink('http://pumpic.com/store.html', ['source' => 'system', 'medium' => 'system-email', 'campaign' => 'abandoned_cart', 'content' => 'notification1']) ?>" style="<?= $style['button'] ?>">
    Go to the Store
</a>
<p style="<?= $style['paragraph'] ?>">
...
<a class="btn" href="<?= $this->analyticsLink('http://pumpic.com/faq.html', ['source' => 'system', 'medium' => 'system-email', 'campaign' => 'abandoned_cart', 'content' => 'notification1']) ?>" style="<?= $style['button'] ?>">
    I need help
</a>
<p style="<?= $style['paragraph'] ?>">
In case you have finished the purchase and received this email by mistake, please, press  <a style="<?= $style['textLink'] ?>" href="<?= $this->analyticsLink('https://cp.pumpic.com/?alreadycompletedpurchase='.$params['email'], ['source' => 'system', 'medium' => 'system-email', 'campaign' => 'abandoned_cart', 'content' => 'notification1']) ?>" >
