...
<p style="<?= $style['paragraph'] ?>">
    ...
    <a class="btn" style="<?= $style['button'] ?>" href="<?= $this->analyticsLink('https://support.apple.com/en-us/HT202664', ['term' => 'supportApple']) ?>" style="<?= $style['textLink'] ?>">https://support.apple.com/en-us/HT202664</a>
</p>
<?php $this->stop() ?>
