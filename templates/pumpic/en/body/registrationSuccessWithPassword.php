...
<p style="<?= $style['paragraph'] ?>">Access your Control Panel on <a style="<?= $style['textLink'] ?>" href="<?= $this->analyticsLink('https://cp.pumpic.com/', ['term' => 'login']) ?>" >cp.pumpic.com</a> or download Pumpic Control Panel Mobile Application for Android devices on Google Play (limited functionality).</p>
